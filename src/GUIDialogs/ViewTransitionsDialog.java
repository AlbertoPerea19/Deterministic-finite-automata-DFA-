...
public class ViewTransitionsDialog extends javax.swing.JDialog {    
    ...
    private void updateTable() {
        ...
        for(Transition t: transitionsList){
            row[0] = t.getestadoActual();
            row[1] = t.getsymbol();
            row[2] = t.getestadoSiguiente();            
            model.addRow(row);
        }
    ...
    private void initComponents() {
        ...
        if (tableTransitions.getColumnModel().getColumnCount() > 0) {
            tableTransitions.getColumnModel().getColumn(0).setResizable(false);
            tableTransitions.getColumnModel().getColumn(1).setResizable(false);
            tableTransitions.getColumnModel().getColumn(2).setResizable(false);
        }
